...
class ExportVideoFrame {
  static const MethodChannel _channel = MethodChannel('flutter_export_video_frames');
  ...
  static Future<bool> saveImage(File file, String albumName,{required String waterMark,required Alignment alignment,required double scale}) async {
